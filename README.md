# TaskFlow API
![Backend Tests](https://github.com/Emmy-2024/edl-starter/workflows/backend.yml)
![Frontend Tests](https://github.com/Emmy-2024/edl-starter/workflows/frontend.yml)
